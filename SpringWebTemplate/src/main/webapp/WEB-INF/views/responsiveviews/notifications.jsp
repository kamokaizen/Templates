...
<body>
				...
				<div class="col-lg-12">
					...
					<div class="chat-panel panel panel-default">
						<div class="panel-heading">
							...
							<div class="btn-group pull-right">
								...
								<ul class="dropdown-menu slidedown">
									<li><a href="javascript:refreshNotifications()"> <i
						...
						<div class="input-group" style="margin: 5px">
							...
							<input id="searchNotificationTextField" type="text"
						...
						<div class="panel-footer">
							...
							<button type="button" id="notifications_pager_button"
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">
							<spring:message code="emailPreview" />
						</h4>
					</div>
	...
	<script src="<%=request.getContextPath()%>/resources/js/impl/notifications.js"></script>
</body>
