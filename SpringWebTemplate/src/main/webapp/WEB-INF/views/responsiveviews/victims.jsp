...
<body>
				...
				<div class="col-lg-12">
					...
					<div class="chat-panel panel panel-default">
						<div class="panel-heading">
							...
							<div class="btn-group pull-right">
								...
								<ul class="dropdown-menu slidedown">
									<li><a href="javascript:refreshVictims()"> <i
						...
						<div class="input-group" style="margin: 5px">
							...
							<input id="searchVictimTextField" type="text"
						...
						<div class="panel-body">
							<ul id="notification_users_listview_component" class="chat">
							</ul>
						</div>
						<!-- /.panel-body -->
						<div class="panel-footer">
							<spring:message code="button_loading" var="button_loading" />
							<button type="button" id="notification_user_pager_button"
	            ...
	            <div class="modal-content">
	                ...
	                <div class="modal-body">
						<div align="center">
						   ...
						   <div class="form-group"><input id="createNameField" class="form-control" type="text" name="notificationUsername" path="notificationUsername" placeholder="Ad" placeholder="${placeholder_name}"/></div>
				 	  	   <div class="form-group"><input id="createSurnameField" class="form-control" type="text" name="notificationUsersurname" path="notificationUsersurname" placeholder="Soyad" placeholder="${placeholder_surname}"/></div>
						   <div class="form-group"><input id="createUsernameField" class="form-control" type="text" path="notificationUserusername" name="notificationUserusername" placeholder="Kullanıcı Adı" placeholder="${placeholder_username}"/></div>
						   <div class="form-group"><input id="createEmailField" class="form-control" type="text" path="notificationUseremail" name="notificationUseremail" placeholder="E-posta" placeholder="${placeholder_email}"/></div>
	            ...
	            <div class="modal-content">
	                ...
	                <div class="modal-body">
				       <div align="center">
						   ...
						   <div class="form-group"><input id="updateNameField" class="form-control" type="text" name="notificationUsername" path="notificationUsername" placeholder="Ad" /></div>
				 	  	   <div class="form-group"><input id="updateSurnameField" class="form-control" type="text" name="notificationUsersurname" path="notificationUsersurname" placeholder="Soyad" /></div>
						   <div class="form-group"><input id="updateUsernameField" class="form-control" type="text" path="notificationUserusername" name="notificationUserusername" placeholder="Kullanıcı Adı"/></div>
						   <div class="form-group"><input id="updateEmailField" class="form-control" type="text" path="notificationUseremail" name="notificationUseremail" placeholder="E-posta"/></div>
	...
	<script src="<%=request.getContextPath()%>/resources/js/impl/victims.js"></script>
</body>
